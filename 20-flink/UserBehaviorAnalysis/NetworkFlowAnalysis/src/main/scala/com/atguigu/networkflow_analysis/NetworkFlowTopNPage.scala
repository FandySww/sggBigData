...
object NetworkFlowTopNPage {
  def main(args: Array[String]): Unit = {
    ...
    // 从文件读取数据
    val inputStream = env.readTextFile("D:\\codeMy\\CODY_MY_AFTER__KE\\sggBigData\\20-flink\\UserBehaviorAnalysis\\NetworkFlowAnalysis\\src\\main\\resources\\apache.log")
