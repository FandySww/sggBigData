...
object OutputTableTest {
  def main(args: Array[String]): Unit = {
    ...
    // 读取数据创建DataStream
    val inputStream: DataStream[String] = env.readTextFile("D:\\codeMy\\CODY_MY_AFTER__KE\\sggBigData\\20-flink\\FlinkTutorial\\src\\main\\resources\\sensor.txt")
    ...
    tableEnv.connect( new FileSystem().path("D:\\codeMy\\CODY_MY_AFTER__KE\\sggBigData\\20-flink\\FlinkTutorial\\src\\main\\resources\\out1.txt") )
      .withFormat( new Csv() )
